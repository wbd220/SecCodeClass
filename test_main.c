...
START_TEST(test_check_words_normal)
    {
        ...
        ck_assert_msg(strcmp(misspelled[1], expected[1]) == 0, "got %s, wanted %s", misspelled[0], expected[0]);
        ck_assert_msg(strcmp(misspelled[2], expected[2]) == 0, "got %s, wanted %s", misspelled[0], expected[0]);
    }
END_TEST
